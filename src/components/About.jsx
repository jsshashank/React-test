...
export default function About() {
  return (
    <section id="about" className="prose max-w-none px-10 pt-28 pb-20">
      {/* <h2 className="text-2xl font-Playfair font-semibold mb-4">About Me</h2> */}
      <h3 className="  font-semibold text-1xl pb-3">Welcome to my Portfolio 👋,</h3>
      <h1 className="font-Playfair font-semibold text-7xl mb-3">I'm Jalli Sai Shashank</h1>
      <p className=" text-[1.20rem] text-gray-600 font-semibold mb-3">Data Science • Machine-Learning • DBMS</p>
      ...
      <div className="flex flex-col sm:flex-row gap-4 mt-10">
        <a
          href="#contact"
          className="px-6 py-3 bg-white text-black rounded-full font-medium text-center
