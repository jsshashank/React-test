...
export default function GlassUI() {
  return (<>
    <div
      className="glass-ui fixed bottom-0 left-1/2 -translate-x-1/2 px-3 py-2 flex items-center rounded-none w-full text-white text-lg flex justify-center gap-5"
      style={{
    ...
    >
      ...
      <div className="flex items-center gap-2 px-4">
        <a href="#image" className="bg-white/6 hover:bg-white/10 px-3 py-1 rounded-lg flex items-center gap-2 ">
